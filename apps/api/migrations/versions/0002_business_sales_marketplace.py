...
revision = "0002_business_sales_marketplace"
...
def upgrade() -> None:
    op.create_table("business_leads",
        ...
        sa.Column("email", sa.String(320), nullable=False), sa.Column("source", sa.String(80), nullable=False),
    ...
    op.create_table("opportunities",
        sa.Column("id", sa.Integer(), primary_key=True), sa.Column("lead", sa.String(160), nullable=False),
        sa.Column("value", sa.Float(), nullable=False, server_default="0"),
        sa.Column("stage", sa.String(40), nullable=False, server_default="new"),
        sa.Column("created_at", sa.DateTime(), nullable=False))
    op.create_table("sales_campaigns",
        sa.Column("id", sa.Integer(), primary_key=True), sa.Column("name", sa.String(160), nullable=False),
        sa.Column("channel", sa.String(80), nullable=False), sa.Column("status", sa.String(40), nullable=False, server_default="draft"),
        sa.Column("created_at", sa.DateTime(), nullable=False))
    op.create_table("marketplace_products",
        sa.Column("id", sa.Integer(), primary_key=True), sa.Column("name", sa.String(160), nullable=False),
        sa.Column("kind", sa.String(60), nullable=False), sa.Column("price", sa.Float(), nullable=False, server_default="0"),
